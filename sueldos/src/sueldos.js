...
function buscarSueldosYGenerarMensaje(){
		...
		if  (!!valoresIngresados.sueldo){
			...
			if (valoresIngresados.sueldo < sueldos.minimo) {
					...
					$("#emoji").append('<img src="dist/disappointed-but-relieved-face.png" class="img-responsive fitbox">');
				}
				else if ((sueldos.minimo<valoresIngresados.sueldo) && (valoresIngresados.sueldo<sueldos.maximo)) {
					$("#porcentaje").text('Estás en la media');
					$("#emoji").append('<img src="dist/winking-face.png" class="img-responsive fitbox">');
					...
					$("#emoji").append('<img src="dist/Money_Face_Emoji.png" class="img-responsive fitbox">');
				}
			}
